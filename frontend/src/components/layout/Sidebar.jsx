...
import { LayoutDashboard, Upload, FileText, Settings, Building2, LogOut } from 'lucide-react';
...
const Sidebar = () => {
    ...
    const fetchCompanyInfo = async () => {
        try {
            ...
            // Set initial state from localStorage to avoid delay
            if (companyName) {
            ...
            // Sync localStorage name just in case it was updated in settings
    ...
    return (
        <div className="h-screen w-64 bg-slate-900 text-white border-r border-slate-700 flex flex-col">
            ...
            {company && (
                <div className="p-4 border-t border-slate-700">
                    {company.name ? (
                        ...
                        <Link to="/settings" className="flex items-center space-x-3 text-sm text-slate-400 hover:text-emerald-400 transition-colors">
